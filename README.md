...
The program accepts three arguments: -file , -lbd , and -(ivp|fvp|np). All of the arguments are optional. See the python help as:
...
Lewy Body Dementia forms can have IVP or FVP arguments.
