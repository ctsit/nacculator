...
def update_header(record, packet):
    for header in packet:
        ...
        formrater = ''
        try:
            if header.FORMID.value == "Z1X":
                formdate = record['fu_z1x_date']
                formrater = record['fu_z1x_rater']
            elif header.FORMID.value == "A3A":
                formdate = record['fu_a3a_date']
                formrater = record['fu_a3a_rater']
            elif header.FORMID.value == "B3F":
                formdate = record['fu_b3f_date']
                formrater = record['fu_b3f_rater']
            elif header.FORMID.value == "B9F":
                formdate = record['fu_b9f_date']
                formrater = record['fu_b9f_rater']
            elif header.FORMID.value == "C1F":
                formdate = record['fu_c1f_date']
                formrater = record['fu_c1f_rater']
            elif header.FORMID.value == "C2F":
                formdate = record['fu_c2f_date']
                formrater = record['fu_c2f_rater']
            elif header.FORMID.value == "C3F":
                formdate = record['fu_c3f_date']
                formrater = record['fu_c3f_rater']
            elif header.FORMID.value == "C4F":
                formdate = record['fu_c4f_date']
                formrater = record['fu_c4f_rater']
            elif header.FORMID.value == "C5F":
                formdate = record['fu_c5f_date']
                formrater = record['fu_c5f_rater']
            elif header.FORMID.value == "C6F":
                formdate = record['fu_c6f_date']
                formrater = record['fu_c6f_rater']
            elif header.FORMID.value == "E2F":
                formdate = record['fu_e2f_date']
                formrater = record['fu_e2f_rater']
            elif header.FORMID.value == "E3F":
                formdate = record['fu_e3f_date']
                formrater = record['fu_e3f_rater']
