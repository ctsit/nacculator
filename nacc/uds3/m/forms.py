...
class FormM(nacc.ubs.FieldBag): # DECEASED,DISCONT field skips (not yet implement skip)
    def __init__(self):
        ...
        self.fields['DROPREAS'] = nacc.uds3.Field(name='DROPREAS', typename='Num', position=(176,176), length=1, inclusive_range=(0, 1), allowable_values=['1', '0'], blanks=['Blank if Question 2a PROTOCAL = 1 (Follow-up by telephone)', 'Blank if Question 2a PROTOCAL = 2 (Minimal contact)', 'Blank if Question 2a PROTOCAL = 3 (Annual in-person follow-up)', 'Blank if Question 3 FTLDDISC = 1 (Discontinue FTLD)', 'Blank if Question 4b DISCONT ne 1 (Yes)'])
