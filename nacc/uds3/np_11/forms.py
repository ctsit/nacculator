...
# This packet is for NP (Neuropath) version 11 forms


def header_fields():
    fields = {}
    fields['FORMVER'] = nacc.uds3.Field(name='FORMVER', typename='Num', position=(932, 933), length=2, inclusive_range=(11, 11), allowable_values=[], blanks=[])
...
class FormNP(nacc.uds3.FieldBag):
    def __init__(self):
        ...
        self.fields['NPHEMO1'] = nacc.uds3.Field(name='NPHEMO1', typename='Num', position=(372, 372), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=['Blank if Question 12b NPHEMO ne 1 (Yes)'])
        self.fields['NPHEMO2'] = nacc.uds3.Field(name='NPHEMO2', typename='Num', position=(374, 374), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=['Blank if Question 12b NPHEMO ne 1 (Yes)'])
        self.fields['NPHEMO3'] = nacc.uds3.Field(name='NPHEMO3', typename='Num', position=(376, 376), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=['Blank if Question 12b NPHEMO ne 1 (Yes)'])
        ...
        self.fields['NPARTAG'] = nacc.uds3.Field(name='NPARTAG', typename='Num', position=(513, 513), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPATGSEV'] = nacc.uds3.Field(name='NPATGSEV', typename='Num', position=(515, 515), length=1, inclusive_range=(1, 3), allowable_values=['8', '9'], blanks=["Blank if Question 18a NPARTAG ne 1 (Yes)"])
        self.fields['NPATGAMY'] = nacc.uds3.Field(name='NPATGAMY', typename='Num', position=(517, 517), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=["Blank if Question 18a NPARTAG ne 1 (Yes)"])
        self.fields['NPATGAM1'] = nacc.uds3.Field(name='NPATGAM1', typename='Num', position=(519, 519), length=1, inclusive_range=(0, 2), allowable_values=['8', '9'], blanks=["Blank if Question 18a NPARTAG ne 1 (Yes)", "Blank if Question 18c NPATGAMY ne 1 (Yes)"])
        self.fields['NPATGAM2'] = nacc.uds3.Field(name='NPATGAM2', typename='Num', position=(521, 521), length=1, inclusive_range=(0, 2), allowable_values=['8', '9'], blanks=["Blank if Question 18a NPARTAG ne 1 (Yes)", "Blank if Question 18c NPATGAMY ne 1 (Yes)"])
        self.fields['NPATGAM3'] = nacc.uds3.Field(name='NPATGAM3', typename='Num', position=(523, 523), length=1, inclusive_range=(0, 2), allowable_values=['8', '9'], blanks=["Blank if Question 18a NPARTAG ne 1 (Yes)", "Blank if Question 18c NPATGAMY ne 1 (Yes)"])
        self.fields['NPATGAM4'] = nacc.uds3.Field(name='NPATGAM4', typename='Num', position=(525, 525), length=1, inclusive_range=(0, 2), allowable_values=['8', '9'], blanks=["Blank if Question 18a NPARTAG ne 1 (Yes)", "Blank if Question 18c NPATGAMY ne 1 (Yes)"])
        self.fields['NPATGAM5'] = nacc.uds3.Field(name='NPATGAM5', typename='Num', position=(527, 527), length=1, inclusive_range=(0, 2), allowable_values=['8', '9'], blanks=["Blank if Question 18a NPARTAG ne 1 (Yes)", "Blank if Question 18c NPATGAMY ne 1 (Yes)"])
        self.fields['NPATGFRN'] = nacc.uds3.Field(name='NPATGFRN', typename='Num', position=(529, 529), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=["Blank if Question 18a NPARTAG ne 1 (Yes)"])
        self.fields['NPATGFR1'] = nacc.uds3.Field(name='NPATGFR1', typename='Num', position=(531, 531), length=1, inclusive_range=(0, 2), allowable_values=['8', '9'], blanks=["Blank if Question 18a NPARTAG ne 1 (Yes)", "Blank if Question 18e NPATGFRN ne 1 (Yes)"])
        self.fields['NPATGFR2'] = nacc.uds3.Field(name='NPATGFR2', typename='Num', position=(533, 533), length=1, inclusive_range=(0, 2), allowable_values=['8', '9'], blanks=["Blank if Question 18a NPARTAG ne 1 (Yes)", "Blank if Question 18e NPATGFRN ne 1 (Yes)"])
        self.fields['NPATGFR3'] = nacc.uds3.Field(name='NPATGFR3', typename='Num', position=(535, 535), length=1, inclusive_range=(0, 2), allowable_values=['8', '9'], blanks=["Blank if Question 18a NPARTAG ne 1 (Yes)", "Blank if Question 18e NPATGFRN ne 1 (Yes)"])
        self.fields['NPATGFR4'] = nacc.uds3.Field(name='NPATGFR4', typename='Num', position=(537, 537), length=1, inclusive_range=(0, 2), allowable_values=['8', '9'], blanks=["Blank if Question 18a NPARTAG ne 1 (Yes)", "Blank if Question 18e NPATGFRN ne 1 (Yes)"])
        self.fields['NPPDXA'] = nacc.uds3.Field(name='NPPDXA', typename='Num', position=(539, 539), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXB'] = nacc.uds3.Field(name='NPPDXB', typename='Num', position=(541, 541), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXC'] = nacc.uds3.Field(name='NPPDXC', typename='Num', position=(543, 543), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXD'] = nacc.uds3.Field(name='NPPDXD', typename='Num', position=(545, 545), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXE'] = nacc.uds3.Field(name='NPPDXE', typename='Num', position=(547, 547), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXF'] = nacc.uds3.Field(name='NPPDXF', typename='Num', position=(549, 549), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXG'] = nacc.uds3.Field(name='NPPDXG', typename='Num', position=(551, 551), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXH'] = nacc.uds3.Field(name='NPPDXH', typename='Num', position=(553, 553), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXI'] = nacc.uds3.Field(name='NPPDXI', typename='Num', position=(555, 555), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXJ'] = nacc.uds3.Field(name='NPPDXJ', typename='Num', position=(557, 557), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXK'] = nacc.uds3.Field(name='NPPDXK', typename='Num', position=(559, 559), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXL'] = nacc.uds3.Field(name='NPPDXL', typename='Num', position=(561, 561), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXM'] = nacc.uds3.Field(name='NPPDXM', typename='Num', position=(563, 563), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXN'] = nacc.uds3.Field(name='NPPDXN', typename='Num', position=(565, 565), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXO'] = nacc.uds3.Field(name='NPPDXO', typename='Num', position=(567, 567), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXP'] = nacc.uds3.Field(name='NPPDXP', typename='Num', position=(569, 569), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXQ'] = nacc.uds3.Field(name='NPPDXQ', typename='Num', position=(571, 571), length=1, inclusive_range=(0, 1), allowable_values=['8', '9'], blanks=[])
        self.fields['NPPDXR'] = nacc.uds3.Field(name='NPPDXR', typename='Num', position=(573, 573), length=1, inclusive_range=(0, 1), allowable_values=[], blanks=[])
        self.fields['NPPDXRX'] = nacc.uds3.Field(name='NPPDXRX', typename='Char', position=(575, 604), length=30, inclusive_range=(), allowable_values=[], blanks=['Blank If Question 18r NPPDXR = 0 (No)'])
        self.fields['NPPDXS'] = nacc.uds3.Field(name='NPPDXS', typename='Num', position=(606, 606), length=1, inclusive_range=(0, 1), allowable_values=[], blanks=[])
        self.fields['NPPDXSX'] = nacc.uds3.Field(name='NPPDXSX', typename='Char', position=(608, 637), length=30, inclusive_range=(), allowable_values=[], blanks=['Blank If Question 18s NPPDXS = 0 (No)'])
        self.fields['NPPDXT'] = nacc.uds3.Field(name='NPPDXT', typename='Num', position=(639, 639), length=1, inclusive_range=(0, 1), allowable_values=[], blanks=[])
        self.fields['NPPDXTX'] = nacc.uds3.Field(name='NPPDXTX', typename='Char', position=(641, 670), length=30, inclusive_range=(), allowable_values=[], blanks=['Blank If Question 18t NPPDXT = 0 (No)'])
        self.fields['NPBNKA'] = nacc.uds3.Field(name='NPBNKA', typename='Num', position=(672, 672), length=1, inclusive_range=(0, 1), allowable_values=['9'], blanks=[])
        self.fields['NPBNKB'] = nacc.uds3.Field(name='NPBNKB', typename='Num', position=(674, 674), length=1, inclusive_range=(0, 1), allowable_values=['9'], blanks=[])
        self.fields['NPBNKC'] = nacc.uds3.Field(name='NPBNKC', typename='Num', position=(676, 676), length=1, inclusive_range=(0, 1), allowable_values=['9'], blanks=[])
        self.fields['NPBNKD'] = nacc.uds3.Field(name='NPBNKD', typename='Num', position=(678, 678), length=1, inclusive_range=(0, 1), allowable_values=['9'], blanks=[])
        self.fields['NPBNKE'] = nacc.uds3.Field(name='NPBNKE', typename='Num', position=(680, 680), length=1, inclusive_range=(0, 1), allowable_values=['9'], blanks=[])
        self.fields['NPBNKF'] = nacc.uds3.Field(name='NPBNKF', typename='Num', position=(682, 682), length=1, inclusive_range=(0, 1), allowable_values=['9'], blanks=[])
        self.fields['NPBNKG'] = nacc.uds3.Field(name='NPBNKG', typename='Num', position=(684, 684), length=1, inclusive_range=(0, 1), allowable_values=['9'], blanks=[])
        self.fields['NPFAUT'] = nacc.uds3.Field(name='NPFAUT', typename='Num', position=(686, 686), length=1, inclusive_range=(0, 1), allowable_values=['9'], blanks=[])
        self.fields['NPFAUT1'] = nacc.uds3.Field(name='NPFAUT1', typename='Char', position=(688, 747), length=60, inclusive_range=(), allowable_values=[], blanks=['Blank if Question 19h NPFAUT ne 1 (Yes)'])
        self.fields['NPFAUT2'] = nacc.uds3.Field(name='NPFAUT2', typename='Char', position=(749, 808), length=60, inclusive_range=(), allowable_values=[], blanks=['Blank if Question 19h NPFAUT ne 1 (Yes)'])
        self.fields['NPFAUT3'] = nacc.uds3.Field(name='NPFAUT3', typename='Char', position=(810, 869), length=60, inclusive_range=(), allowable_values=[], blanks=['Blank if Question 19h NPFAUT ne 1 (Yes)'])
        self.fields['NPFAUT4'] = nacc.uds3.Field(name='NPFAUT4', typename='Char', position=(871, 930), length=60, inclusive_range=(), allowable_values=[], blanks=['Blank if Question 19h NPFAUT ne 1 (Yes)'])