...
def build_uds3_fvp_form(record):
    ...
    a3.SIB17PDX  = record['fusib17pdx'] #TODO - listed as fu_sib17pdx in dd, fusib17pdx in redcap
    ...
    a3.KID9AGD   = record['fukid9agd'] #TODO -> listed as fu_kid9agd in dd and fukid9agd in redcap
    ...
    b8.GAITAPRA  = record['fu_sivdfind'] #DD says fu_gaitapra, TODO is this fu_sivdfind (in the same position) ?
    ...
    b8.OTHNEUR   = record['fu_otherneur'] #Previously fu_othneur TODO Typo? fu_otherneur
    b8.OTHNEURX  = record['fu_otherneur'] #Previously fu_othneurx TODO Typo? fu_otherneur
    packet.append(b8)
    ...
    d1.STROKCOG  = record['fu_strokedec'] #Previously fu_strokcog TODO Are both same? fu_strokedec in same position
